...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        navigate_home_action.setStatusTip("duck duck go")
        ...
        self.setWindowTitle("OPTIMAL BROWSER")
        self.setWindowIcon(QIcon(os.path.join('icons', 'kivy.png')))
    ...
    def tab_open_draglink(self, i):
        if i == -1:
            self.add_new_tab()

    # CLOSE TABS
    def close_current_tab(self, i):
        if self.tabs.count() < 0: #Only close if there is more than one tab open
            return
...
# APPLICATION NAME
app.setApplicationName("OPTIMAL BROWSER ")
# APPLICATION COMPANY NAME
app.setOrganizationName("Optimal Ke")
# APPLICATION COMPANY ORGANISATION
app.setOrganizationDomain("optimal.org")
